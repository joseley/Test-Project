                    ...
                    <form method="post" action="{{ url()->current() }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                id="locationName" name="location_name" type="text" placeholder="Location Name" value="{{ $location->location_name ?? '' }}">
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                id="shopperLimit" name="shopper_limit" type="number" placeholder="Shopper Limit" value="{{ $location->shopper_limit ?? 0 }}">
                        </div>
